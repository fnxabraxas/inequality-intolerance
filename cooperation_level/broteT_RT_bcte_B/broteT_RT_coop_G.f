...
c   coopBR_TOT = ( y*coopBRwA + (1-y)*coopBRwB  ) *(1-epsA) 
     ...
     +		  outfileARtoA, outfileBRtoA, outfileBRtoB 
		...
		double precision Gini,Gfin, epsT, GG,
     +			coopARwA, coopBRwA, coopBRwB, epsAB, wG,
     +			GiniA, GiniB, GfinA, GfinB
		...
		print*,'number of G'
		read(*,*) NG
	print*, 'Output files (3): '
	read(*,*) outfileARtoA, outfileBRtoA, outfileBRtoB  
	...
	!print*,Gini,gfin,epsT,yy,GG,epsA,epsB
        ...
        write(92,'(2F10.4,4x,2F10.4)') GG, coopBRwA, epsA, epsB
        write(93,'(2F10.4,4x,2F10.4)') GG, coopBRwB, epsA, epsB        
        GG=GG+wG
